...
* https://msdn.microsoft.com/library/ms681381.aspx
    ...
    **Exit/error codes table**
        ...
        5962	ERROR_CLUSTER_NODE_DRAIN_IN_PROGRESS	A node drain is already in progress. This value was also named ERROR_CLUSTER_NODE_EVACUATION_IN_PROGRESS.
        ...
        8644	ERROR_DOMAIN_SID_SAME_AS_LOCAL_WORKSTATION	The domain join cannot be completed because the SID of the domain you attempted to join was identical to the SID of this machine. This is a symptom of an improperly cloned operating system install. You should run sysprep on this machine in order to generate a new machine SID. Please see http://go.microsoft.com/fwlink/p/?linkid=168895 for more information.
        ...
        9103	DNS_ERROR_NSEC3_INCOMPATIBLE_WITH_RSA_SHA1	NSEC3 is not compatible with the RSA-SHA-1 algorithm. Choose a different algorithm or use NSEC. This value was also named DNS_ERROR_INVALID_NSEC3_PARAMETERS.
        ...
        12000	ERROR_INTERNET_*	See Internet Error Codes and WinInet.h.
        ...
        13856	ERROR_IPSEC_IKE_SRVQUERYCRED	Failed to determine SSPI principal name for ISAKMP/ERROR_IPSEC_IKE service (QueryCredentialsAttributes).
